@php use Bambamboole\MyCms\Models\MenuItem; @endphp
@props(['item'])
        ...
        <div class="flex items-center gap-2">
            ...
            @if($hasChildren)
                <x-filament::icon-button
                    ...
                    x-bind:title="open ? '{{ trans('mycms::menu.items.collapse') }}' : '{{ trans('mycms::menu.items.expand') }}'"
                    color="gray"
