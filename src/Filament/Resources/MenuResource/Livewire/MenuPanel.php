...
use Bambamboole\MyCms\Filament\Resources\MenuResource\MenuPanel\MenuPanel as MenuPanelInterface;
        ...
        return $form
            ->schema([
                Components\View::make('filament-tables::components.empty-state.index')
                    ->viewData([
                        'heading' => __('mycms::menu.panel.empty.heading'),
                        'description' => __('mycms::menu.panel.empty.description'),
